...
//				}
	...
	public static void main(String []args){
		...
		ZeroSumBimatrixGameSolver s = new ZeroSumBimatrixGameSolver();
		double[][] payout = {{3.,-1.},{-2.,1.}};
		System.out.println("payoff: " + s.solveForMinimaxValue(payout));
		double[][] payout2 = {{3.,-2.},{-1.,1.}};
		System.out.println("payoff: " + s.solveForMinimaxValue(payout2));
